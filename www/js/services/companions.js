...
export const HEROINES = {
  valen: {
    ...
    race: 'alicorn',
    raceName: 'Alicornio',
    title: 'Princesa de las Estrellas',
  ...
  zoe: {
    ...
    title: 'Princesa de la Naturaleza',
  ...
  lia: {
    ...
    race: 'unicorn',
    raceName: 'Unicornio',
    title: 'Princesa de los Cristales',
...
/**
 * Diálogos de presentación del Cuarteto (SSOT editorial).
 * Antes vivían copiados en app.js y campaign-page.js.
 */
export const INTRO_DIALOGUES = {
  valen: '«¡Las constelaciones de <strong>Lumiria</strong> nos llaman! El <strong>Velo de la Duda</strong> de la Emperatriz Eclipse ha dispersado los diez sellos estelares. Somos el <strong>Cuarteto de la Armonía</strong>: cuatro princesas, cuatro magias, una sola promesa. ¡Elige con quién empezar y encendamos las estrellas!»',
...
export function getIntroDialogue(heroineId) {
  return INTRO_DIALOGUES[heroineId] || INTRO_DIALOGUES.valen;
}
