/* @ts-self-types="./kidslearn_wasm.d.ts" */
...
export class MathSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MathSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    generate_next_challenge() {
        wasm.mathsession_generate_next_challenge(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
     ...
     */
    get_highest_streak() {
        const ret = wasm.mathsession_get_highest_streak(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
     */
    get_last_correct() {
        const ret = wasm.mathsession_get_last_correct(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get_mastery() {
        const ret = wasm.mathsession_get_mastery(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
    ...
    get_mastery_percentage() {
        const ret = wasm.mathsession_get_mastery_percentage(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_operand1() {
        const ret = wasm.mathsession_get_operand1(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_operand2() {
        const ret = wasm.mathsession_get_operand2(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {string}
    ...
    get_operator() {
        ...
        try {
            ...
            wasm.mathsession_get_operator(retptr, this.__wbg_ptr);
    ...
    get_options_json() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mathsession_get_options_json(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    get_state_json() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mathsession_get_state_json(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     */
    get_streak() {
        const ret = wasm.mathsession_get_streak(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
    ...
    get_tier_name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mathsession_get_tier_name(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     */
    get_total_answered() {
        const ret = wasm.mathsession_get_total_answered(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     ...
     * @param {bigint} seed
     * @param {number} initial_tier
     */
    constructor(seed, initial_tier) {
        const ret = wasm.mathsession_new(seed, initial_tier);
        this.__wbg_ptr = ret;
        MathSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @param {number} initial_tier
     */
    reset(seed, initial_tier) {
        wasm.mathsession_reset(this.__wbg_ptr, seed, initial_tier);
    }
    /**
     ...
     * @returns {boolean}
     */
    submit_answer(user_answer, elapsed_ms) {
        const ret = wasm.mathsession_submit_answer(this.__wbg_ptr, user_answer, elapsed_ms);
        return ret !== 0;
    }
}
...
export class ReadingSession {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ReadingSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_readingsession_free(ptr, 0);
    }
    /**
    ...
    constructor() {
        ...
        this.__wbg_ptr = ret;
        ReadingSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    parse_text_syllables(text) {
        ...
        try {
            ...
            wasm.readingsession_parse_text_syllables(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
...
export function get_engine_version() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_engine_version(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./kidslearn_wasm_bg.js": import0,
    };
}

const MathSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mathsession_free(ptr, 1));
const ReadingSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_readingsession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kidslearn_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
